...
const LEAF_ANCHORS =
  "A 10 is the most intense usual culinary form of that taste: 10 sweet = sugar or brown sugar (crystalline); 10 spicy = thai chili or habanero; 10 umami = fish sauce; 10 bitter = unsweetened espresso. Table salt is the exception: salty ≈ 12 (above the 0–10 mouthful scale) so a spoon still seasons a bowl without over-punching other seasonings. Do not hand out 10s because a food is iconic — a spoon of a 10 seasons a whole bowl; salt at 12 seasons harder. Rank relative intensity carefully: raise or lower a draft only when a cook would immediately reject the number; prefer small corrections when the ballpark is right. Honey ≈ 9–10 sweet; orange ≈ 7–8 sweet; mirin / sweet cooking sake ≈ 5–7 sweet (noticeably sweet, far below crystalline sugar — never score mirin at or above brown sugar or table sugar on sweet); onion ≈ 0–1 sweet. Lemon or lime fruit ≈ 9 sour; lemon or lime juice ≈ 9.5 (not 10). Lactic-fermented vegetables (kimchi, sauerkraut, pickles) are clearly sour ≈ 7–8; yogurt / kefir milder ≈ 4–5; vinegar ≈ 9. Juice, paste, and extract score higher than the whole food (juice ≠ fruit; paste ≠ the vegetable). plain cheese ≈ 5 salty (not sauce-level); parmesan ≈ 7–8 salty; soy sauce / fish sauce / oyster sauce / miso ≈ 8.5–10 salty (below table salt). black pepper ≈ 0.2 spicy (freshly cracked ≈ 0.5). Spicy is chili heat only (capsaicin): ginger, garlic, onion, mustard, horseradish, wasabi, and Sichuan peppercorn are 0 spicy. Black pepper is not chili — 0.2 is the ceiling unless freshly cracked (~0.5). Salty is how salty a mouthful tastes, not milligrams of sodium on a nutrient label. Sodium bicarbonate and other non-salt sodium compounds still show up as 'sodium' in the draft. Functional pantry chemicals (leaveners, thickeners, starches, oils, additives) stay near 0 salty even if the draft is 9–10. Salt, soy, fish sauce, and ham stay high. Salty and umami are different: a sauce can be both very salty and very umami. Do not lower salty to 'make room' for umami or because the food tastes savory/balanced.";
